...
```bash
python main.py example.png -o output.svg --pixel_size 10
```
...
```bash
python main.py INPUT_FILE [-o OUTPUT_FILE] [--preserve_alpha] [--pixel_size PIXEL_SIZE] [--overlap OVERLAP]
```
...
4. It writes the final SVG file using the original pixel layout.
